...
function agregarProducto(e) {
    e.preventDefault();
    console.log("1. Función agregarProducto ejecutada");

    // SE OBTIENE DESDE EL FORMULARIO EL JSON A ENVIAR
    var productoJsonString = document.getElementById('description').value;
    console.log("2. JSON obtenido:", productoJsonString);
    // SE CONVIERTE EL JSON DE STRING A OBJETO
    var finalJSON = JSON.parse(productoJsonString);
    // SE AGREGA AL JSON EL NOMBRE DEL PRODUCTO
    finalJSON['nombre'] = document.getElementById('name').value;
    console.log("3. Nombre del producto:", finalJSON['nombre']);
    // SE OBTIENE EL STRING DEL JSON FINAL
    productoJsonString = JSON.stringify(finalJSON,null,2);
    console.log("4. JSON final:", productoJsonString);
 ...
 */
    ...
    client.onreadystatechange = function () {
        ...
        try {
            ...
            // Solo listar productos si fue exitoso
